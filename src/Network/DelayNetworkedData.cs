...
//         InnerNetObjectCollection obj = __instance.allObjects;
//         lock (obj)
//         {
//             HashSet<GameObject> hashSet = [];
//             Il2CppSystem.Collections.Generic.IReadOnlyList<InnerNetObject> readOnlyList = __instance.allObjects.AllObjects;
//             int length = readOnlyList.CastFast<Il2CppSystem.Collections.Generic.IEnumerable<InnerNetObject>>().Count();
//             for (int i = 0; i < length; i++)
//             {
//                 InnerNetObject innerNetObject = obj[i];
...
//         bool flag;
//         __instance.PackAndSendQueuedMessages(__instance.reliableMessageQueue, 1, out flag);
//         if (flag)
//         {
//             __instance.numberOfConsecutiveFramesWithReliableMessages++;
//             if (__instance.numberOfConsecutiveFramesWithReliableMessages > 5)
//             {
//                 __instance.serverLogger.Warning(string.Format("{0} - sending queued reliable messages for {1} frames in a row", "SendAllStreamedObjects", __instance.numberOfConsecutiveFramesWithReliableMessages), null);
//             }
//         }
//         else
//         {
//             __instance.numberOfConsecutiveFramesWithReliableMessages = 0;
//         }
//         bool flag2;
//         __instance.PackAndSendQueuedMessages(__instance.unreliableMessageQueue, 0, out flag2);
//         if (flag2)
//         {
//             __instance.numberOfConsecutiveFramesWithUnreliableMessages++;
//             if (__instance.numberOfConsecutiveFramesWithUnreliableMessages > 5)
//             {
//                 __instance.serverLogger.Warning(string.Format("{0} - sending queued unreliable messages for {1} frames in a row", "SendAllStreamedObjects", __instance.numberOfConsecutiveFramesWithUnreliableMessages), null);
//             }
//         }
//         else
//         {
//             __instance.numberOfConsecutiveFramesWithUnreliableMessages = 0;
//         }
//         InnerNetObjectCollection obj = __instance.allObjects;
//         lock (obj)
//         {
//             __instance.PackAndSendDirtyStreamedObjects(__instance.allObjects.AllReliableObjects, 1, ref __instance.indexForReliableStreamedUpdates);
//             __instance.PackAndSendDirtyStreamedObjects(__instance.allObjects.AllUnreliableObjects, 0, ref __instance.indexForUnreliableStreamedUpdates);
//         }
//         return false;
//     }
//
